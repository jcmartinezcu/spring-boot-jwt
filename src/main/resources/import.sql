...
INSERT INTO `users` (username, password, enabled) VALUES ('andres','$2a$10$aG4edExdBepHawpJngYdDey7EnjBrhqBqWHoqPHk575l/V.S8/98q',1);
INSERT INTO `users` (username, password, enabled) VALUES ('admin','$2a$10$f/9CwR.XhkCeCsy28ijZF.dYQNp8ROXsQR55p.r.oJy.97uZc9lRq',1);
